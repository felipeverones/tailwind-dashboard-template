...
function DashboardCardVoluntarios() {

  const chartData = {
    labels: ['Estudantes UFSC','Outros'],
    datasets: [
      {
  ...
  return ( //col span muda o tamanho das colunas pra diferente tipos de tela
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Distribuição de Voluntários</h2>
      </header>
...
export default DashboardCardVoluntarios;
